...
public class GUISwitch extends GUI {
	...
	public GUISwitch(String s, int id, int x, int y, int w, int h) {
		super(x, y, w, h);
		this.text = s;
		this.reactID = id;
		setColor(Color.BLUE);
	...
	public GUISwitch(Image img, Image hover, int id, int x, int y, int w, int h) {
		super(x, y, w, h);
		this.img = img;
		this.hover = hover;
		this.reactID = id;
	...
	public GUISwitch(Image img, Image hover, String txt, int id, int x, int y, int w, int h) {
		super(x, y, w, h);
		this.img = img;
		this.hover = hover;
		this.reactID = id;
	...
	public GUISwitch setColor(Color c){
		color = new Color(c.getRed(),c.getGreen(),c.getBlue(),100);
		return this;
	}
	
	public GUISwitch setColor(int r, int g, int b){

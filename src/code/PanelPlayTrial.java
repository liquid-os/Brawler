...
public class PanelPlayTrial extends GridPanel{
	...
	public void onEnd(boolean vic){
		runDeath = true;
		if(vic){
			Analysis.increment(new File(Bank.path+"data/trial.HB"), "wins", 1);
			...
			Analysis.increment(new File(Bank.path+"data/trial.HB"), "losses", 1);
		}
